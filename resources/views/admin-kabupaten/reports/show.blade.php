...
<body class="min-h-screen relative">
    ...
    <div class="bg-[#7fc8c6] px-8 py-6 shadow relative z-10">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white text-sm">Admin Kabupaten Indramayu</p>
            </div>
    ...
    <div class="relative z-10 flex justify-center py-10">
        <div class="w-[600px] bg-white/70 backdrop-blur-md rounded-2xl p-6 shadow-xl">
            ...
            <div class="space-y-3 text-sm">
                <div>
                    <b>Desa Pelapor</b><br>
                    <p class="bg-white/50 rounded-lg px-3 py-2 mt-1">
                ...
                <div>
                    <b>Kecamatan</b><br>
                    <p class="bg-white/50 rounded-lg px-3 py-2 mt-1">{{ $report->kecamatan ?? '-' }}</p>
                </div>

                <div>
                    <b>Nama Pelapor</b><br>
                    <p class="bg-white/50 rounded-lg px-3 py-2 mt-1">{{ $report->user->name ?? '-' }}</p>
                </div>
                ...
                <div>
                    ...
                    @if($report->kewenangan == 'Kabupaten')
                    ...
                    @else
                        <span class="px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-600">🏘️ Desa</span>
                    @endif
                </div>
            ...
            <!-- FORM UPDATE - UNTUK ADMIN KABUPATEN (HANYA JIKA STATUS BELUM SELESAI DAN BELUM DITOLAK) -->
            @if($report->status != 'ditolak' && $report->status != 'selesai')
            <div class="mt-6 pt-4 border-t border-gray-300">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <!-- Upload Foto Bukti Perbaikan (khusus status selesai) -->
        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-4 text-center">
                    ...
                    <p class="text-blue-100 text-sm">Kab. Indramayu</p>
                </div>
                <div class="px-6 py-6">
    ...
    <script>
        ...
        function updateStatus(status, kewenangan = null, catatan = null, alasanTolak = null) {
            ...
            .then(data => {
                if (data.success) {
                    window.location.href = "{{ route('admin-kabupaten.dashboard') }}";
                } else {
