...
class ReportController extends Controller
{
    ...
    public function updateStatus(Request $request, $id)
    {
        try {
            ...
            if ($request->catatan_provinsi) {
                $report->catatan_provinsi = $request->catatan_provinsi;
            }

            if ($request->alasan_tolak_provinsi) {
            ...
            if ($request->hasFile('foto_perbaikan')) {
                ...
                $filename = 'perbaikan_prov_' . time() . '_' . $report->id . '.' . $file->getClientOriginalExtension();
            ...
            $report->is_read_provinsi = true;   // provinsi sudah baca
